...
// Espelha a tabela `messages` e a função riskguard_mark_message_read de
// supabase/supabase_step2.sql.
...
export function countUnread(messages: Message[], recipientType: 'gestor' | 'operador'): number {
  // recipiente = o outro papel, ou a IA (mensagens da IA sempre contam pra
  // quem está operando a máquina, isto é, o operador).
